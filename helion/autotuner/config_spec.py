...
class ConfigSpec:
    ...
    def _flat_fields(
        ...
        if is_tileir:
            ...
            # NPU: num_warps and num_stages are not supported
            # NPUBackend.supports_config_key returns False for these keys
            num_warps_fragment = NumWarpsFragment(1, 1)
